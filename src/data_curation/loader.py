...
from src.config import MIN_PRICE, MAX_PRICE, DATASET_NAME, DATASET_CATEGORY
...
class ItemLoader:
    ...
    def load(self, workers=8):
        ...
        self.dataset = load_dataset(DATASET_NAME, f"raw_meta_{self.name}", split="full", trust_remote_code=True)
